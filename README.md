...
```
cd existing_repo
git remote add origin https://gitlab.addamant-work.ru/bgallery/bgallery-front.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.addamant-work.ru/bgallery/bgallery-front/-/settings/integrations)
