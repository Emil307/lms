...
export const useAttachArticlesToCourse = ({ courseId }: Pick<AttachArticlesToCourseRequest, "courseId">) => {
    return useMutation<AttachArticlesToCourseResponse, AxiosError<FormErrorResponse>, Omit<AttachArticlesToCourseRequest, "courseId">>(
