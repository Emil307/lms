...
import { createStyles, MantineNumberSize, CSSObject, MantineTheme, MantineGradient } from "@mantine/styles";
...
export interface AvatarStylesParams {
    ...
    classNames: Partial<Record<"root" | "image" | "placeholder" | "placeholderIcon", string>> | undefined;
    styles: any;
...
export default createStyles((theme, { size, radius, color, withinGroup, spacing, variant, gradient }: AvatarStylesParams) => {
