...
declare module "nextjs-routes" {
  ...
  export type Route =
    ...
    | StaticRoute<"/admin/static-pages/main-page/advantages">
    | StaticRoute<"/admin/static-pages/main-page/banner/edit">
    | StaticRoute<"/admin/static-pages/main-page/banner">
